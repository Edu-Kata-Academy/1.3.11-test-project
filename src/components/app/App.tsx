...
import { changeFieldValue, setCurrencies, setCurrentCurrency, setMainCurrency, setPopupCurrency } from "../../services/currenciesSlice";
...
function App() {
  ...
  useEffect(() => {
    if (response && response.Valute) {
      ...
      dispatch(setPopupCurrency({
        firstPopupCurrencyCharCode: response.Valute.CHF.CharCode, 
        secondPopupCurrencyCharCode: response.Valute.CHF.CharCode
      })); 
    }
  }, [response, dispatch]);
  ...
  if (currencyObjectOfFirstField && currencyObjectOfSecondField) {
    ...
    rateForSecondField = currencyObjectOfSecondField.Value / currencyObjectOfFirstField.Value;
      ...
      if (currencyObjectOfFirstField && currencyObjectOfSecondField &&
          currencyObjectOfFirstField.CharCode === 'RUR' && currencyObjectOfSecondField.CharCode === 'RUR') {
